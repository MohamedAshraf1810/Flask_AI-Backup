...
def FaceRec_Model(username):
    ...
    try:
        ...
        test_image = face_recognition.load_image_file('face_Recognition_Utilities/SVC_Testimgs/Users_Photos/'+username+'.png')
        ...
        for i in range(no):
            ...
            if (max_acc < 80 or predictedName == 'other'):
                ...
                print("The Model Accuracy Is = " , round(max_acc,2) , "%")
                sucessfulAuth = True
            print("sucessfulAuth : ",sucessfulAuth)   
        # Print Accuracy
        print("propa_name",propa_name)
    except Exception as e:
        print(e)

    return sucessfulAuth
